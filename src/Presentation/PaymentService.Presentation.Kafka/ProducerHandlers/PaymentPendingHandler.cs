...
public class PaymentPendingHandler : IEventHandler<PaymentPendingEvent>
{
    private readonly IKafkaMessageProducer<PaymentStatusKey, PaymentStatusValue> _messageProducer;

    public PaymentPendingHandler(IKafkaMessageProducer<PaymentStatusKey, PaymentStatusValue> messageProducer)
    {
        _messageProducer = messageProducer;
    }

    public async ValueTask HandleAsync(PaymentPendingEvent evt, CancellationToken cancellationToken)
    {
